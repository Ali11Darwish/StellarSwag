...
if ( ! @file_exists( 'C:\xampp\htdocs\StellarSwag\wp-content\plugins\breeze/breeze.php' ) ) { return; }
$config['config_path'] = 'C:\xampp\htdocs\StellarSwag/wp-content/breeze-config/breeze-config.php';
...
if ( @file_exists( 'C:\xampp\htdocs\StellarSwag\wp-content\plugins\breeze/inc/cache/execute-cache.php' ) ) {
	include_once 'C:\xampp\htdocs\StellarSwag\wp-content\plugins\breeze/inc/cache/execute-cache.php';
}
